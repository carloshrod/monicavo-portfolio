...
const ContactForm = () => {
	...
	return (
		...
		>
			...
			{isFormSend ? (
				<span
					className='w-full py-2 px-4 bg-stone-200 text-center text-center text-sm text-green-500 rounded bg-shadow'
					role='alert'
				>
					Message sent ✔
				</span>
